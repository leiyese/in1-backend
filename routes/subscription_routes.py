...
def create_subscription_route():
    ...
    return jsonify({
        ...
        "subcription_id": new_subscription.subscription_id,
...
def create_subscription_type_route():
    ...
    return jsonify({
        ...
        "subscription_type_id": new_subscription_type.subscription_type_id,
...
def get_subscription_type_by_id_route(subscription_type_id):
    ...
    return jsonify(subscription_type.serialize())
